...
def login():
    ...
    if user and user.check_password(data['password']):
        ...
        return jsonify(accessToken=access_token, user={"id": user.id, "email": user.email, "firstName": user.first_name, "lastName": user.last_name, "displayName": user.display_name})
